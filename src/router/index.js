  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: "Leaderboard",
        component: () =>
          import("@/modules/gamification/views/LeaderboardView.vue"),
      },
      {
        path: "rewards",
        name: "Rewards",
        component: () => import("@/modules/gamification/views/RewardsView.vue"),
      },
      {
        path: "map",
        name: "Map",
        component: () => import("@/modules/maps/views/HotspotMapView.vue"),
      },
      {
        path: "admin",
        name: "Admin",
...
router.beforeEach(async (to) => {
  ...
  if (to.meta.requiresAdmin && !authStore.profile?.is_admin)
    return { name: "Dashboard" };
});
